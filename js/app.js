...
async function submitOrder() {
  ...
  try {
    ...
    // booked_slots/{dateKey}_{slot} acts as a mutex document.
    // The transaction reads it first — if it already exists the slot is taken
    // and we throw before writing anything.
    ...
    Logger.success(`Booking saved — Firestore ID: ${bookingRef.id}`);
